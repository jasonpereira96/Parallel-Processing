...
const bool USE_LOADBALANCER = true;
...
void sort_and_print(vector<int> &arr, int id)
{
    ...
    // }
    // my code
    ofstream output_file(USE_LOADBALANCER?"Sorted-LB.txt":"Sorted-No-LB.txt", std::ios_base::app);
    if (output_file.is_open())
    {
...
vector<int> loadbalancing(int totalElements, int totalProcessors, vector<int> &localArray, int pid)
{ // int low, int high,
...
int main(int argc, char **argv)
{
    ...
    if (myid == 0)
    {
        ...
        // data = {105, 579, 713, 1222, 137, 560, 301, 254, 1234, 187, 1218, 456, 228, 1529, 1940, 1600, 1500, 1895, 1753, 1688, 2223, 1722, 2342, 2355, 2872, 2916, 2648, 2836, 2688, 3246, 3152, 3319, 3155, 3601, 4141, 4059, 4512, 4417, 4000, 4215, 3880, 4558, 3964, 4886, 5288, 4873, 5064, 5372, 5461, 5267, 5256, 5652, 6177, 6001, 5657, 6037, 5686, 6132, 6697, 6420, 6623, 6531, 6611, 6806, 8143, 9461, 10480, 8731, 9571, 8231, 8059, 7420, 9388, 7546, 8639, 9182, 7638, 8571, 7648, 8188, 9860, 7132, 7997, 8855, 10530, 8779, 8325, 7511, 9125, 8984, 9029, 8024, 8468, 9803, 7715, 7480, 8624, 9065, 9171, 9064};
    ...
    if (myid == 0)
    {
        ofstream output_file(USE_LOADBALANCER?"Sorted-LB.txt":"Sorted-No-LB.txt", std::ios_base::out);
